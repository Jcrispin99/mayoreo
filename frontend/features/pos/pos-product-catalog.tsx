...
const FILTER_OPTIONS: ListFilterOption[] = [
  ...
  { id: 'stock:positive', label: 'Con stock', group: 'Existencias', icon: 'package-variant-closed-check' },
  { id: 'stock:zero', label: 'Stock en cero', group: 'Existencias', icon: 'package-variant-closed' },
  { id: 'stock:negative', label: 'Stock negativo', group: 'Existencias', icon: 'package-variant-closed-minus' },
        ...
        <View style={styles.searchArea}>
          <View style={styles.searchComponent}>
            <ListSearch
              ...
              filtersTitle="Filtros múltiples"
