              ...
              <View style={styles.card}>
                <View style={styles.cashRegisterHeader}>
                  <View style={styles.cashRegisterIcon}>
                    <Icon color="#B4232D" size={27} source="cash-register" />
                  </View>
                ...
                <View style={styles.locationLine}>
                  <Icon color="#60706E" size={17} source="map-marker-outline" />
...
const styles = StyleSheet.create({
  ...
  error: { marginBottom: 14, padding: 12, borderRadius: 10, color: '#8F1D2C', backgroundColor: '#FCE8EA', fontSize: 11, fontWeight: '700' },
  card: { padding: 20, borderWidth: 1, borderColor: '#D7E0DE', borderRadius: 16, backgroundColor: '#FFFFFF', gap: 18 },
  cashRegisterHeader: { flexDirection: 'row', alignItems: 'center', gap: 13 },
  cashRegisterIcon: { width: 54, height: 54, borderRadius: 13, backgroundColor: '#FFE5E5', alignItems: 'center', justifyContent: 'center' },
  cashRegisterIdentity: { flex: 1, minWidth: 0 },
  eyebrow: { color: '#B4232D', fontSize: 9, fontWeight: '900', letterSpacing: 0.8 },
  title: { marginTop: 3, color: '#172423', fontSize: 25, fontWeight: '900' },
  cashRegisterName: { marginTop: 2, color: '#60706E', fontSize: 11 },
  locationLine: { padding: 11, borderRadius: 9, backgroundColor: '#EAEFEE', flexDirection: 'row', alignItems: 'center', gap: 7 },
  locationText: { flex: 1, color: '#60706E', fontSize: 10 },
  amountSection: { gap: 5 },
  amountTitle: { color: '#172423', fontSize: 14, fontWeight: '900' },
  amountHelp: { marginBottom: 8, color: '#60706E', fontSize: 10, lineHeight: 15 },
